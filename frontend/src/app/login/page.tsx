      ...
      <div className="w-full max-w-md animate-fade-in z-10 flex flex-col">
        ...
        <div className="geek-card w-full p-8 shadow-[6px_6px_0px_0px_rgba(18,18,18,1)] bg-white">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-9 pr-10 py-2.5 bg-slate-50 border-2 border-slate-900 focus:bg-white focus:ring-1 focus:ring-slate-900 outline-none text-slate-900 text-xs placeholder:text-slate-400 transition-all font-geek"
                />
                <button
                  type="button"
          ...
          <p className="mt-8 text-center text-xs text-slate-500 uppercase tracking-wider">
            ...
            <Link href="/register" className="text-slate-900 hover:text-emerald-600 font-bold transition-colors underline decoration-2">
              Sign up
            </Link>
          </p>
        </div>
