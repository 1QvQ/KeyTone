      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-wrap items-center justify-between py-3 sm:py-0 sm:h-16 gap-y-3">
          ...
          <div className="flex items-center gap-2 sm:gap-4 order-2">
            <Link href="/profile" className="flex items-center gap-2 border-2 border-slate-900 bg-slate-50 px-3 py-1 text-xs font-bold uppercase tracking-wider text-slate-800 hover:bg-slate-200 transition-colors cursor-pointer">
